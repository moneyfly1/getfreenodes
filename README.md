...
- **统一密码**: 所有注册账号使用统一密码 `<SERVER_ROOT_PASSWORD_REMOVED>@`
...
统一密码: <SERVER_ROOT_PASSWORD_REMOVED>@
格式: 时间 | 网址 | 邮箱 | 密码 | 状态
==================================================
时间: 2024-01-01 12:01:00 | 网址: https://example.com/getnodelist | 邮箱: abc123456@gmail.com | 密码: <SERVER_ROOT_PASSWORD_REMOVED>@ | 状态: 成功-注册+登录+获取节点
```
...
### 🔐 统一密码
- 所有注册账号使用相同密码: `<SERVER_ROOT_PASSWORD_REMOVED>@`
- 包含大小写字母、数字和特殊字符
